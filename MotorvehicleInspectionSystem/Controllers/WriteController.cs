    ...
    public class WriteController : Controller
    {
        ...
        public User[] LYYDJKW001(RequestData requestData, ResponseData responseData)
        {
            ...
            try
            {
                ...
                if (!IPAddress.TryParse(login.IP, out IPAddress ip))
                {
                ...
                if (VehicleInspectionController.SyHj == "1")
                {
                    ...
                    string sql = string.Format("select rysfz as SfzInfoID,GongHao,RyName as username,RyPassWord  as PassWord,RyName as turename,getdate() as AddDate, RyRight as RoleDm from [dbo].[TbSystemUserInfo] where RyName ='{0}'  and RyPassWord ='{1}'", login.UserName, login.PassWord);
                    //判断用户名密码
                    users = db.QueryForList<User>(sql, null);
                    responseData.Code = "1";
                    responseData.Message = "SUCCESS";
        ...
        public SaveResult[] LYYDJKW004(RequestData requestData, ResponseData responseData)
        {
            ...
            try
            {
                ...
                //更新收费状态
                string sqlStr = "update baseinfo_hand set sfjf='1' where lsh='" + chargePayment.chargeOrder.Ajlsh + "'";
                dbAj.ExecuteNonQuery(sqlStr, null);
                responseData.Code = "1";
                responseData.Message = "SUCCESS";
            }
            catch (ArgumentNullException)
        ...
        public SaveResult[] LYYDJKW007(RequestData requestData, ResponseData responseData)
        {
            ...
            try
            {
                ...
                foreach (Object o in requestData.Body)
                {
                    ...
                    SaveResult saveResult = new SaveResult
                    {
                        ID = inspectionPhotoW007.ID,
                        Jkbh = "LYYDJKW007",
                        Zpdm = inspectionPhotoW007.Zpdm,
                        Zpmc = inspectionPhotoW007.Zpmc
                    };
                    ...
                    if (inspectionPhotoW007.BcHj == "1")
                    {
                        if (VehicleInspectionController.SyHj == "1")
                        {
                            ...
                            catch (Exception e)
                            {
                                ...
                                //loggerHelper.Error(this.GetType(), new LogContent("LYYDJKW007", "", "Write", e.Message + "-----" + sql));
                            }
                        }
                        else
                        {
        ...
        public SaveResult[] LYYDJKW008(RequestData requestData, ResponseData responseData)
        {
            ...
            try
            {
                ...
                foreach (Object o in requestData.Body)
                {
                    ...
                    SaveResult saveResult = new SaveResult
                    {
                        ID = inspectionVideoW008.ID,
                        Jkbh = "LYYDJKW008",
                        Spbh = inspectionVideoW008.Spbhaj + "-" + inspectionVideoW008.Spbhhj
                    };
        ...
        public SaveResult[] LYYDJKW009(RequestData requestData, ResponseData responseData)
        {
            ...
            try
            {
                ...
                foreach (Object o in requestData.Body)
                {
                    ...
                    SaveResult saveResult = new SaveResult
                    {
                        ID = photographW009.ID,
                        Jkbh = "LYYDJKW009",
                        Zpgw = photographW009.Zpgw,
                        Zpdm = photographW009.Zpdm
                    };
                    ...
                    if (VehicleInspectionController.SyAj == "1")
                    {
                        try
                        {
                            ...
                            EndpointAddress address = new EndpointAddress("http://192.168.10.100:8096/HCNETWebService.asmx");
        ...
        public SaveResult[] LYYDJKW010(RequestData requestData, ResponseData responseData, string zdbs)
        {
            ...
            try
            {
                ...
                if (projectStartW010.Ajywlb != "-")
                {
                    ...
                    {
                        //projectStartW010.Kssj = HttpUtility.UrlEncode(projectStartW010.Kssj, Encoding.UTF8);
                        //序列化为XML
                        ...
                        //保存日志
                        TmriOutInterfaceLog tmriOutInterfaceLog = new TmriOutInterfaceLog();
                        tmriOutInterfaceLog.SendStr = xmlDocStr;
                        tmriOutInterfaceLog.ReturnStr = resultXml;
                        tmriOutInterfaceLog.TerminalIp = zdbs;
                        tmriOutInterfaceLog.Jkid = "18C55";
                        tmriOutInterfaceLog.KeyInfo = projectStartW010.Ajlsh;
                        tmriOutInterfaceLog.SaveLog(dbAj);
                        //分析返回结果
                        XmlDocument doc = new XmlDocument();
                        doc.LoadXml(resultXml);
                        code = XMLHelper.GetNodeValue(doc, "code");
            ...
            try
            {
                ...
                if (VehicleInspectionController.SyAj == "1")
                {
                    ...
                    if (systemParameterAj.Jcfs == "1" && ajywlbLw.Contains(ajywlb))
                    {
                        ...
                        tmriOutInterfaceLog.ReturnStr = resultXml;
                        tmriOutInterfaceLog.TerminalIp = zdbs;
                        tmriOutInterfaceLog.Jkid = "18C80";
                        tmriOutInterfaceLog.KeyInfo = ajlsh;
                        tmriOutInterfaceLog.SaveLog(dbAj);
                        //分析返回结果
                        XmlDocument doc = new XmlDocument();
                        doc.LoadXml(resultXml);
                ...
                if (VehicleInspectionController.SyHj == "1")
                {
                    ...
                    if (hjywlb != "-")
                    {
                        ...
                        if (projectData.Jyxm == "F1")
                        {
                            ...
                            sqlDelete = "delete from [dbo].[JcDate_Work_JC] where lsh ='" + projectDataF1.Hjlsh + "' and jccs ='" + projectDataF1.Hjjccs + "' and dalb ='F1'";
                            sqlHj = "INSERT INTO [dbo].[JcDate_Work_JC]([Lsh] ,[hpzl] ,[hphm],[Jccs],[JcDate],[KsTime],[JsTime],[JcPj],[DaLB],[WorkJcxm],[WorkMan],[TD_JC],InBz_01)VALUES (";
                            ...
                            sqlHj += " '" + String.Join(";", bhgXm.ToArray()) + "')";
                            dbHj.ExecuteNonQuery(sqlDelete, null);
            ...
            try
            {
                ...
                if (projectEndW012.Ajywlb != "-")
                {
                    ...
                    if (systemParameterAj.Jcfs == "1" && ajywlbLw.Contains(projectEndW012.Ajywlb))
                    {
                        ...
                        tmriOutInterfaceLog.ReturnStr = resultXml;
                        tmriOutInterfaceLog.TerminalIp = zdbs;
                        tmriOutInterfaceLog.Jkid = "18C58";
                        tmriOutInterfaceLog.KeyInfo = projectEndW012.Ajlsh;
                        tmriOutInterfaceLog.SaveLog(dbAj);
                        //分析返回结果
                        XmlDocument doc = new XmlDocument();
                        doc.LoadXml(resultXml);
        ...
        public SaveResult[] LYYDJKW013(RequestData requestData, ResponseData responseData, string zdbs)
        {
            ...
            try
            {
                ...
                if (examine.Ajywlb != "-" && !string.IsNullOrEmpty(examine.Ajywlb))
                {
                    ...
                    int countE = Convert.ToInt32(dbAj.ExecuteScalar(sql, null));
                    if (countE == 1)
                    {
                        sql = "UPDATE [dbo].[T_AuditStatus] set ";
                        sql += " [shzt] = '2'";
                        sql += " ,[shsj] = convert(varchar(19),getdate(),120)";
                        sql += " ,[shdz] = '" + zdbs + "'";
                        sql += " ,[shr] = '" + examine.Shr + "'";
                        sql += " ,[shrsfzh] = '" + examine.Shrsfzh + "'";
                        sql += " ,[shcs] = '" + examine.Shcs + "'";
                        sql += " ,[shjg] = '" + examine.Shjg + "'";
                        sql += " ,[shsm] = '" + examine.Shsm + "'";
                        sql += " ,[qm] = '" + examine.Qm + "'";
                        sql += " WHERE lsh='" + examine.Ajlsh + "' and sqcs ='" + examine.Ajsqcs + "'";
                        int reInt = dbAj.ExecuteNonQuery(sql, null);
                        if (reInt == 1)
                        {
                            responseData.Code = "1";
                            responseData.Message = "SUCCESS";
                        ...
                        {
                            responseData.Code = "-1";
                            responseData.Message = "影响数据行数：" + reInt.ToString();
                        }
                    }
                    else
                    {
                ...
                if (examine.Hjywlb != "-" && !string.IsNullOrEmpty(examine.Hjywlb))
                {
                    DbUtility dbHj = new DbUtility(VehicleInspectionController.ConstrHj, DbProviderType.SqlServer);
                    string sql = "select count(*) from T_AuditStatus where lsh='" + examine.Hjlsh + "' and sqcs ='" + examine.Hjsqcs + "'";
                    int countE = Convert.ToInt32(dbHj.ExecuteScalar(sql, null));
                    if (countE == 1)
                    {
                        sql = "UPDATE [dbo].[T_AuditStatus] set ";
                        sql += " [shzt] = '2'";
                        ...
                        sql += " ,[shsm] = '" + examine.Shsm + "'";
                        sql += " ,[qm] = '" + examine.Qm + "'";
                        sql += " WHERE lsh='" + examine.Hjlsh + "' and sqcs ='" + examine.Hjsqcs + "'";
                        int reInt = dbHj.ExecuteNonQuery(sql, null);
                        if (reInt == 1)
                        {
                            responseData.Code = "1";
                            responseData.Message = "SUCCESS";
        ...
        public SaveResult[] LYYDJKW014(RequestData requestData, ResponseData responseData, string zdbs)
        {
            ...
            try
            {
                ...
                if (roadTestDataW014.Jyxm.Contains("R1"))
                {
                    ...
                    sqlStr += " '" + roadTestDataW014.Jckssj + "',"; // ,<kstime, datetime,>
                    sqlStr += " '" + roadTestDataW014.Jcjssj + "',"; // ,<jstime, datetime,>
                    sqlStr += " '" + zcpj + "',"; // ,<jcpj, varchar(2),>
                    ...
                    sqlStr += " '" + (roadTestDataW014.ZdjlPj == "1" ? "○" : "×") + "',"; // ,<data09, varchar(8),>
                    sqlStr += " '" + (roadTestDataW014.XtsjPj == "1" ? "○" : "×") + "',"; // ,<data10, varchar(8),>
                    sqlStr += " '" + "≤" + roadTestDataW014.XtsjBz + "',"; // ,<data11, varchar(8),>
                    sqlStr += " '" + (roadTestDataW014.MFDDPj == "1" ? "○" : "×") + "',"; // ,<data12, varchar(8),>)"
                ...
                if (roadTestDataW014.Jyxm.Contains("R2"))
                {
                    var zcqk = "不溜坡";
                    var zcpj = "○";
                    if (roadTestDataW014.Lszczdpd == "不合格")
                    {
                        zcqk = "溜坡";
                        zcpj = "×";
                    }
                    ...
                    int reI = dbAj.ExecuteNonQuery(sqlStr, null);
                    if (roadTestDataW014.Zczdcsff == "1")
                    {
                        sqlStr = "INSERT INTO [dbo].[JcData_R]";
                        sqlStr += " ([lsh],[hpzl],[hphm],[jccs],[dalb],[jcdate],[kstime],[jstime]";
                        sqlStr += " ,[jcpj],[data01],[data02],[data03],[data04],[data05],bz1) VALUES( ";
                        sqlStr += " '" + roadTestDataW014.Ajlsh + "',"; // (<lsh, varchar(17),>
                        sqlStr += " '" + roadTestDataW014.Hpzl + "',"; // ,<hpzl, varchar(2),>
                        sqlStr += " '" + roadTestDataW014.Hphm + "',"; // ,<hphm, varchar(8),>
                        sqlStr += " '" + roadTestDataW014.Ajjccs + "',"; // ,<jccs, int,>
                        ...
                        sqlStr += " '" + roadTestDataW014.Zcscfm + "',"; // ,<data03, varchar(8),>)"
                        sqlStr += " '" + zcqk + "',"; // ,<data04, varchar(8),>
                        sqlStr += " '1',"; // ,<data05, varchar(8),>
                        sqlStr += " '" + roadTestDataW014.Lsy + "')";
                    }
                    else
                    {
                        ...
                        sqlStr += " '" + roadTestDataW014.Jcjssj + "',"; // ,<jstime, datetime,>
                        sqlStr += " '" + zcpj + "',"; // ,<jcpj, varchar(2),>
                        sqlStr += " '" + roadTestDataW014.Zcsczm + "',"; // ,<data01, varchar(8),>
                        sqlStr += " '" + roadTestDataW014.Zcll + "',"; // ,<data02, varchar(8),>
                        sqlStr += " '" + roadTestDataW014.Zcscfm + "',"; // ,<data03, varchar(8),>)"
                        sqlStr += " '" + roadTestDataW014.Zcllfm + "',"; // ,<data04, varchar(8),>
                        sqlStr += " '2',"; // ,<data05, varchar(8),>
                        sqlStr += " '" + zcqk + "',"; // ,<data06, varchar(8),>)"
                        sqlStr += " '" + roadTestDataW014.Llbzxz + "',"; // ,<data07, varchar(8),>)"
                        sqlStr += " '" + roadTestDataW014.Lsy + "')";
                    }
                    reI = dbAj.ExecuteNonQuery(sqlStr, null);
                }
                ...
                if (systemParameterAj.Jcfs == "1" && ajywlbLw.Contains(roadTestDataW014.Ajywlb))
                {
                    //开始上传到平台
                    //先将类序列化为xml
                    string xmlDocStr = XMLHelper.XmlSerializeStr<RoadTestDataW014>(roadTestDataW014);
                    XmlDocument xmlDocument = new XmlDocument();
                    xmlDocument.LoadXml(xmlDocStr);
                    xmlDocument.Save(@"D:\TestXml\" + roadTestDataW014.Jyxm + "_D.xml");
                    string resultXml = CallingSecurityInterface.WriteObjectOutNew("18", null, "18C54", xmlDocStr);
                    //保存日志
                    TmriOutInterfaceLog tmriOutInterfaceLog = new TmriOutInterfaceLog();
                    tmriOutInterfaceLog.SendStr = xmlDocStr;
                    tmriOutInterfaceLog.ReturnStr = resultXml;
                    tmriOutInterfaceLog.TerminalIp = zdbs;
                    tmriOutInterfaceLog.Jkid = "18C54";
                    tmriOutInterfaceLog.KeyInfo = roadTestDataW014.Ajlsh;
                    tmriOutInterfaceLog.SaveLog(dbAj);
                    //分析返回结果
                    XmlDocument doc = new XmlDocument();
                    doc.LoadXml(resultXml);
                    var code = XMLHelper.GetNodeValue(doc, "code");
                }
                responseData.Code = "1";
                responseData.Message = "SUCCESS";
            ...
            try
            {
                ...
                else
                {
                    dictionary[jcxm] = status;//含则改
                                              //if (jcxm =="R1")
                                              //{
                                              //    if (dictionary.ContainsKey("R2"))
                                              //    {
                                              //        dictionary["R2"] = status;
                                              //    }
                ...
                switch (jcxm)
                {
                    ...
                    case "DC":
                        ...
                        break;
                    case "R1":
                        sql = sql + " jyxmstatus='" + jcxmZtSB.ToString() + "',lszdstatus = '" + status + "'";
                        if (!string.IsNullOrEmpty(jcxh))
                        {
                            sql += ",Man_TD_LS='" + jcxh + "'";
                        }
        ...
        private bool SaveFlowInfoAj(VehicleDetailsRegisteW003 autoInfo, DbUtility dbUtility)
        {
            ...
            try
            {
                ...
                string jcxmjg = "";
                for (int i = 0; i <= autoInfo.JcxmAj.Split(",").Count() - 1; i += 1)
        ...
        private bool SaveFlowdataAj(VehicleDetailsRegisteW003 autoInfo, DbUtility dbUtility)
        {
            try
            {
                ...
                sqlStr += " '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "',"; // ' ,<JcKsTime, datetime,>
        ...
        private bool SaveCoverdataAj(VehicleDetailsRegisteW003 autoInfo, DbUtility dbUtility)
        {
            try
            {
                ...
                if (reDt.Rows.Count > 0)
                {
                    ...
                    sqlStr += " JcKsTime='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "',"; // ',[JcKsTime] = <JcKsTime, datetime,>
                ...
                else
                {
                    ...
                    sqlStr += " ([Lsh],ajywlb,ajjccs,ajjcxm,[Jccs],[Jcxm],[Jcrq],[JcTime],[JcKsTime],[JcJsTime],[JcXH],[JcJg]";
        ...
        public bool SaveBaseinfoNetHj(VehicleDetailsRegisteW003 v, DbUtility dbUtility)
        {
            try
            {
                ...
                SqlStr += "'0',"; // DPF         zqyzl	varchar(8),	---准牵引总质量	number	8
        ...
        private bool SaveJcFlowHj(VehicleDetailsRegisteW003 v, DbUtility dbUtility)
        {
            ...
            try
            {
                ...
                SqlStr += "ZZL,ZbZl,HDZK,ZS,CCRQ,DjRq,GBCX,DgSfTz,JcXm,JcJg,Jc_S,Dly,InBz_01,GW_01,GW_02,GW_03,GW_04,GW_10,GW_05,GW_06,GW_07,Jclb,InBz_02,InBz_03)";
                SqlStr += "values (";
                ...
                if (v.Hjywlb == "2")
                    SqlStr += "'新车',"; // '         GW_06(varchar(8), ---轴数(  改成拍照车型种类 ))
                else
                    SqlStr += "'在用',";// '         GW_06(varchar(8), ---轴数(  改成拍照车型种类 ))
                SqlStr += "'1',";
